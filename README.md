...
* Hitting another player's ball through their next wicket/pole counts for them, but does not award any extra shots for going through the wicket (only the regular bonus shots for hitting a ball)
...
* Since bonus shots will be cleared on scoring the next wicket/pole, use these to line up your next shot carefully
